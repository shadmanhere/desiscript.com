        ...
        <div className="flex flex-col xs:px-2 md:px-6 justify-content-center flex-wrap">
          ...
          <div className="flex items-start mt-10">
            ...
            <div className="flex flex-col flex-wrap">
              ...
              <p className="text-2xl">{frontEndDescription}</p>
            </div>
          </div>
          ...
          <div className="flex items-start mt-10">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-2xl">{backEndDescription}</p>
            </div>
          </div>
          ...
          <div className="flex items-start mt-10">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-2xl">{designerDescription}</p>
            </div>
          </div>
          ...
          <div className="flex items-start mt-10">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-2xl">{agileDescription}</p>
            </div>
          </div>
        </div>
      </div>
