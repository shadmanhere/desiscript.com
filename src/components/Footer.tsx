      ...
      <div className="mr-4 md:px-6 pt-6">
        <div className="flex flex-wrap xs:justify-end xs:text-right md:justify-between xs:flex-col md:flex-row">
          <div className="flex md:gap-x-6 xs:flex-col xs:gap-y-4 md:flex-row">
            <a href="#home" className="md:py-4">
              Home
            </a>
            <a href="#services" className="md:py-4">
              Services
            </a>
            <a href="#skills" className="md:py-4">
              Skills
            </a>
            <a href="#projects" className="md:py-4">
              Projects
            </a>
            <a href="#about" className="md:py-4">
              About
            </a>
            <a href="#contact" className="md:py-4">
              Contact
            </a>
          </div>
          <div className="mb-6 xs:justify-end xs:mt-10 md:mt-1 flex md:justify-center float-right">
            {socialLinks.hasOwnProperty("facebook") && (
              <a
            ...
            {socialLinks.hasOwnProperty("email") && (
              <a
